...
pub const COEFFICIENT_4_LOG_EXTRAPOLATION_OF_INIT_HL_DELTA_FE: FreeEnergy = 1.75 * GAS_CONST * TEMPERATURE; // The unit is [kcal / mol].
...
pub const COEFFICIENT_4_ALL_C_HL_DELTA_FE: FreeEnergy = 0.3;
